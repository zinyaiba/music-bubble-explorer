...
- [ ] 1. 型定義とデータモデルの追加
  - [ ] 1.1 Live, SetlistItem, LiveType の型定義を追加
...
- [ ] 12. チェックポイント - フォームコンポーネントの確認
  - すべてのテストが通ることを確認し、質問があればユーザーに確認する

- [ ] 13. ライブ登録・編集ページの実装
  - [ ] 13.1 LiveEditPageを作成
