...
- [ ] 3.1 TagRegistrationScreenコンポーネント実装
  - 全画面表示の専用タグ登録画面
  - 画面遷移の状態管理システム
  - ナビゲーション履歴とパンくずリスト
  - _要件: 4.1, 4.2, 4.3, 4.4_

- [ ] 3.2 SongSelectionScreenコンポーネント実装
  - ガラスモーフィズムカードによる楽曲一覧表示
  - 高い視認性を持つリスト表示
  - リアルタイム検索とフィルタリング機能
  - _要件: 4.1, 4.2, 4.4, 4.5_

- [ ] 3.3 TagEditingScreenコンポーネント実装
  - 専用画面でのタグ編集インターフェース
  - チップ形式タグの編集機能統合
  - 保存・キャンセル機能の実装
