...
const songTitles = [
  ...
  '夜空ノムコウ', '世界に一つだけの花', '恋人よ', '卒業写真', '青春', '津軽海峡冬景色', '贈る言葉', '乾杯',
  '春よ、来い', 'ひとり上手', '津軽海峡冬景色', '贈る言葉', '乾杯', '青春', '糸', '上野駅', '翼をください',
  '涙そうそう', '島唄', '夜空ノムコウ', '世界に一つだけの花', '恋人よ', '卒業写真', '青春', '津軽海峡冬景色',
  ...
  '夜空ノムコウ', '世界に一つだけの花', '恋人よ', '卒業写真', '青春', '津軽海峡冬景色', '贈る言葉', '乾杯',
  '青春', '糸', '上野駅', '翼をください', '涙そうそう', '島唄', '夜空ノムコウ', '世界に一つだけの花',
  '恋人よ', '卒業写真', '青春', '津軽海峡冬景色', '贈る言葉', '乾杯', '青春', '糸', '上野駅', '翼をください',
  '涙そうそう', '島唄', '夜空ノムコウ', '世界に一つだけの花', '恋人よ', '卒業写真', '青春', '津軽海峡冬景色',
  '贈る言葉', '乾杯', '青春', '糸', '上野駅', '翼をください', '涙そうそう', '島唄', '夜空ノムコウ',
  '世界に一つだけの花', '恋人よ', '卒業写真', '青春', '津軽海峡冬景色', '贈る言葉', '乾杯', '青春', '糸',
  '上野駅', '翼をください', '涙そうそう', '島唄', '夜空ノムコウ', '世界に一つだけの花', '恋人よ', '卒業写真'
...
const musicianNames = [
  ...
  '古賀政男', '服部良一', '中山晋平', '山田耕筰', '滝廉太郎', '宮城道雄', '中能島欣一', '山田流',
  '生田流', '古典', '現代', '邦楽', '洋楽', 'ポップス', 'ロック', 'ジャズ', 'クラシック', 'フォーク'
]
 ...
 * 300曲のテストデータを生成
 */
export function generateLargeDataset(): MusicDatabase {
  const songs: Song[] = []
  ...
  for (let i = 1; i <= 300; i++) {
    ...
    // 人物データを更新
    const updatePeople = (names: string[], type: 'lyricist' | 'composer' | 'arranger') => {
      names.forEach(name => {
...
/**
 * データセットをJSONファイルとして保存
 */
export function saveLargeDataset(): MusicDatabase {
  const dataset = generateLargeDataset()
  
  // ブラウザ環境では直接ファイル保存はできないため、
  // 開発時にはconsole.logでデータを出力
  if (typeof window !== 'undefined') {
    console.log('Large dataset generated:', dataset)
    console.log('Copy this data to src/data/largeMusicData.json:')
